        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div style={{ transform: "none", opacity: 1 }} className="animate-fade-in" data-animate="opacity: 1; transform: none;">
            <h1>
              ...
              <span className="mt-6 block max-w-5xl font-display text-5xl font-bold tracking-tight text-dark [text-wrap:balance] sm:text-6xl">The latest articles and news</span>
            </h1>
            <div className="mt-6 max-w-4xl text-xl text-dark"><p>Dive into our world of web accessibility and software development. Our team of passionate experts shares insights, tips, and best practices to help you become a better developer and create more inclusive digital experiences.</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                    <div className="relative lg:-mx-4 lg:flex lg:justify-end">
                      <div className="pt-10 lg:w-2/3 lg:flex-none lg:px-4 lg:pt-0">
                        ...
                        <a className="mt-8 inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition bg-dark text-white hover:bg-dark/90" aria-label={`${blog.title}`} href={`/blog/${blog.slug}`}>
